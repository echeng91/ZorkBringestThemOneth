...
public class House {
	...
	public static void main(String[] args) {
		...
		while (!choice.equals("exit")) {
			...
			System.out.println(
					"Options: \'take all\', \'take money\', \'exit\', \'view report\', \'move\', \'history\', \'fight\'.");
			...
			if (choice.equalsIgnoreCase("take all")) {
				...
				if(p1.getLocation().getEnemies().isEmpty())
				{
					System.out.println("There are no enemies");
				} else {
					System.out.println(p1.getLocation().displayEnemies());
					System.out.print("Who will you fight?");
